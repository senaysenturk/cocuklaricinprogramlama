  ...
  $.each(questions, function(question_index, question) {
    ...
    $.each(question.answers, function(answer_index, answer) {
      ...
      var opts = {
        ...
        confirmButtonText: "SONRAKİ SORU",
        html : true,
      ...
      if (last_question) {
        opts.confirmButtonText = "Sonucunu gör";
      }
...
function resultsText(state) {
  ...
  switch (true) {
    case (ratio === 1):
      ...
      break;
    case (ratio > 0.9):
      text = "Mükemmel iş çıkardın!";
      break;
    case (ratio > 0.60):
      text = "Oldukça iyiydin.";
      break;
    case (ratio > 0.5):
      text = "Daha iyi yapabiliceğini biliyorsun. ;)";
      break;
    case (ratio < 0.5 && ratio !== 0):
      text = "Diğer sefere daha iyi yapabilirsin.";
      break;
    case (ratio === 0):
      text = "Ups! Eğitimi tekrar almayı ne dersin?";
      break;
  }
  return text;
